...
export default function ColorBends({
  ...
  useEffect(() => {
    const trackTarget = pointerContainerRef?.current ?? containerRef.current;
    if (!trackTarget) return undefined;
    ...
    trackTarget.addEventListener("pointermove", handlePointerMove);
    return () => trackTarget.removeEventListener("pointermove", handlePointerMove);
  }, [pointerContainerRef]);
